        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="level" name="level"
                       class="layui-input" lay-verify="level">
            </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <table  class="layui-table layui-input-block">
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-input-block">
                            <input name="typeAdd" lay-skin="primary" type="checkbox" title="添加" value="1">
                            <input name="typeEdit" lay-skin="primary" type="checkbox" value="1" title="修改">
                            <input name="typeDelete" lay-skin="primary" type="checkbox" value="1" title="删除">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="layui-input-block">
                            <input name="resAdd" lay-skin="primary" type="checkbox" title="添加" value="1">
                            <input name="resEdit" lay-skin="primary" type="checkbox" value="1" title="修改">
                            <input name="resDelete" lay-skin="primary" type="checkbox" value="1" title="删除">
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="layui-input-block">
                            <input name="userAdd" lay-skin="primary" type="checkbox" title="添加" value="1">
                            <input name="userEdit" lay-skin="primary" type="checkbox" value="1" title="修改">
                            <input name="userDelete" lay-skin="primary" type="checkbox" value="1" title="删除">
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div class="layui-input-block">
                            <input name="groupAdd" lay-skin="primary" type="checkbox" title="添加" value="1">
                            <input name="groupEdit" lay-skin="primary" type="checkbox" value="1" title="修改">
                            <input name="groupDelete" lay-skin="primary" type="checkbox" value="1" title="删除">
                        </div>
                    </td>
                </tr>
                </tbody>
